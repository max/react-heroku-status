...
},{"./ReactCurrentOwner":37,"./ReactElement":53,"./ReactPropTypeLocations":72,"./monitorCodeUse":137,"./warning":146,"1YiZ5S":1}],55:[function(require,module,exports){
(function (process){
/**
 * Copyright 2014, Facebook, Inc.
 * All rights reserved.
...
var HerokuStatus = React.createClass({displayName: "HerokuStatus",
  getInitialState: function() {
  ...
  render: function() {
    return (
      React.createElement("div", {classNames: "HerokuStatus"}, 
        React.createElement(HerokuStatusList, {status: this.state.status})
      )
    );
  }
});

React.render(React.createElement(HerokuStatus, null), document.querySelector('#app'));


},{"./status-list.jsx":150,"react":147}],149:[function(require,module,exports){
var React = require('react');
...
module.exports = React.createClass({displayName: "exports",
  render: function() {
    ...
    var statusNodes = statuses.map(function(status) {
      return (
        React.createElement(StatusLight, {statusType: status.statusType, currentStatus: status.currentStatus})
      );
    });

    return (
      React.createElement("div", {classNames: "HerokuStatusList"}, 
        statusNodes
      )
    );
  }
...
},{"./status-light.jsx":149,"react":147}]},{},[148])